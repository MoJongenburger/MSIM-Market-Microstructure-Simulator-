...
struct MarketView {
  ...
  // LOB top-of-book quantities (populated by World if book exposes them).
  // Default 0 when unavailable.  Imbalance ∈ [−1, 1]:
  //   +1 = all depth on bid,  −1 = all depth on ask,  0 = balanced.
  Qty    bid_depth  = 0;
  Qty    ask_depth  = 0;
